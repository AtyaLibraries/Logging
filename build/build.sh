...
SAMPLE_PROJECT="./samples/Logging.Samples.Console/Logging.Samples.Console.csproj"
BENCHMARK_PROJECT="./benchmarks/Logging.Benchmarks/Logging.Benchmarks.csproj"
